...
public class KafkaConfig {
    ...
    @Bean
    public MyKafkaTransactionManager myKafkaTransactionManager(ProducerFactory<String, SourceEntity> myProducerFactory) {
    ...
    public ChainedTransactionManager chainedTransactionManager(JpaTransactionManager jpaTransactionManager,
        ...
        return new ChainedTransactionManager(myKafkaTransactionManager, jpaTransactionManager);
    }
